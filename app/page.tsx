    ...
    return (
      <main style={{position:'fixed',inset:0,display:'flex',alignItems:'center',justifyContent:'center',background:'#0F4C75',padding:'16px'}}>
        <div style={{background:'white',padding:'20px',borderRadius:'24px',width:'100%',maxWidth:'380px'}}>
          ...
          <div style={{textAlign:'center',fontSize:'12px',color:'#666',marginTop:'6px'}}>Без Sofia - само магазини с лимит 3 и поискан шофьор</div>
          ...
          <button onClick={handleAuth} style={{width:'100%',padding:'16px',background:'#22c55e',border:'none',borderRadius:'14px',fontWeight:'bold',color:'white'}}>Влез →</button>
        </div>
      </main>
    );
  }
