  ...
  return (
    <main style={{minHeight:'100vh',background:'#f5f5f5'}}>
      ...
      <div style={{padding:'12px'}}>
        {/* MARKET, ORDERS, SHOP, DRIVER, ADMIN са вътре в пълния файл - виж файла за сваляне за пълната версия */}
        <div style={{background:'white',padding:'12px',borderRadius:'12px',border:'2px solid black'}}>
          Файлът е 469 реда - ако този paste не показва всичко, свали от линка горе: page_fixed.tsx
        </div>
      </div>
