    ...
    if (resendKey) {
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          ...
          html: `<div style="font-family:sans-serif;max-width:500px;margin:0 auto;padding:20px;background:#f9f9f9;border-radius:16px"><h2>Здравей, ${firstName||''}!</h2><p>Твоят код:</p><div style="font-size:32px;font-weight:900;letter-spacing:6px;background:#000;color:#fff;padding:16px 24px;border-radius:12px;text-align:center;margin:20px 0">${code}</div><p style="color:#666;font-size:14px">Важи 10 минути.</p></div>`,
        }),
      });
